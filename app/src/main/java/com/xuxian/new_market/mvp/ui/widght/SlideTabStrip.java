...
public class SlideTabStrip extends LinearLayout {
    ...
    private int slideLineHeightTopDP =2;
    private int slideLineHeightBottomDP=3;
    ...
    protected void onDraw(Canvas canvas) {
        int height = (int) (getHeight()-slideLineHeightBottomDP*getResources().getDisplayMetrics().density);
        ...
        if (childCount > 0) {
            ...
            if (mSelectedOffset > 0.2 && mSelectedOffset < 0.5) {
                ...
                RectF rectF = getRectF(left, (int) (height - ((int) slideLineHeightTopDP * getResources().getDisplayMetrics().density)), right, height);
            ...
            if (mSelectedOffset > 0.8) {
                ...
                RectF rectf = getRectF(left,
                        (int) (height - (((int) slideLineHeightTopDP * getResources().getDisplayMetrics().density) + (1 - footX) * getResources().getDisplayMetrics().density)),
                        right,
                        height
                );
                canvas.drawRoundRect(rectf, 3, 3, mSelectedIndicatorPaint);
